...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：学生管理</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
         ...
         <!--  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="javascript:post('BasicDataServlet?action=collectScore',{'flag':'1'})" target="mainFrame" onFocus="this.blur()" class="score">汇总成绩</a></td>-->
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="basicData/students_import.jsp" target="mainFrame" onFocus="this.blur()" class="add">导入学生</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="center" valign="middle" class="borderright borderbottom">${item.registTime }</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${item.checkInTime }</td>
  ...
  <tr>
    <td align="center" valign="middle" class="fenye">
    	...
    	<a href="javascript:post('BasicDataServlet?action=conditionStudents',
