...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：场次设置</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
	      ...
	      <!--  <form method="post" action="ExamManagerServlet?action=queryExamSession">
	         <span>场次：
	         <select name="examSession" id="level" onchange="javascript:post('ExamManagerServlet?action=queryExamSession',{'examSession':this.value})">
	    <option value="" ></option>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="exammanager/examsession_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">添加场次</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="center" valign="middle" class="borderright borderbottom">${item.num }</td>
