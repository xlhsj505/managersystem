...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：考场设置&nbsp;&nbsp;>&nbsp;&nbsp;添加考场</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="examroom_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增考场</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="../ExamManagerServlet?action=addExamRoom">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">场次：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="examSessionIUID" id="level">
        	<option value="" ></option>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">考试人数：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="datetime" name="examNum" value="" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
