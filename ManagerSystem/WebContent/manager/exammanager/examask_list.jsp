...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：考场参数设置</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="ExamManagerServlet?action=queryExamAsk">
	         <span>学校名：<select name="schoolName" id="level" onchange="javascript:post('ExamManagerServlet?action=queryExamAsk',{'schoolName':this.value})"> 
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="exammanager/examask_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">添加要求</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">考试场次</th>
        <th align="center" valign="middle" class="borderright">是否可用</th>
        <!--  <th align="center" valign="middle">操作</th>-->
      </tr>
      <c:forEach var="item" items="${sessionScope.examAsk.pageData }" varStatus="status">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="center" valign="middle" class="borderright borderbottom">第${item.contents }场-${item.examTime }</td>
  ...
  <tr>
    <td align="center" valign="middle" class="fenye">
    	当前&nbsp;${sessionScope.examAsk.currentPage }&nbsp;/&nbsp;${sessionScope.examAsk.totalPage }&nbsp;页   &nbsp;&nbsp;
    	<a href="javascript:post('ExamManagerServlet?action=queryExamAsk',
    	{'schoolName':'${sessionScope.schoolName }', 'currentPage':'1'})" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
    	<a href="javascript:post('ExamManagerServlet?action=queryExamAsk',
    	{'schoolName':'${sessionScope.schoolName }', 
    	'currentPage':'${sessionScope.examAsk.currentPage-1}'})" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
    	<a href="javascript:post('ExamManagerServlet?action=queryExamAsk',
    	{'idCard':'${sessionScope.idCard }', 'schoolName':'${sessionScope.schoolName }', 
    	'currentPage':'${sessionScope.examAsk.currentPage+1}'})" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
    	<a href="javascript:post('ExamManagerServlet?action=queryExamAsk',
    	{'schoolName':'${sessionScope.schoolName }', 
    	'currentPage':'${sessionScope.examAsk.totalPage}'})" target="mainFrame" onFocus="this.blur()">尾页</a>
    	&nbsp;&nbsp;总共 ${sessionScope.examAsk.totalCount }条
    </td>
  </tr>
</table>
</body>
