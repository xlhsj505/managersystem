...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：考场设置&nbsp;&nbsp;>&nbsp;&nbsp;添加场次</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="examroom_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增场次</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="../ExamManagerServlet?action=addExamSession">
