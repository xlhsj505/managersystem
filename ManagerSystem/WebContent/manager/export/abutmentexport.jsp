...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        <td align="center" valign="middle" class="borderright"><a href="../ExportBooksServlet?action=exportStudents" >学生信息</a></td>
        <td align="center" valign="middle" class="borderright"><a href="../ExportBooksServlet?action=exportExamArrangement" >考试详细信息</a></td>
        <td align="center" valign="middle" class="borderright"><a href="../ExportBooksServlet?action=exportModule" >模块信息</a></td>
        <td align="center" valign="middle" class="borderright"><a href="../ExportBooksServlet?action=exportExam" >考试表</a></td>
        <td align="center" valign="middle" class="borderright"><a href="../ExportBooksServlet?action=exportQuestions" >试题表</a></td>
