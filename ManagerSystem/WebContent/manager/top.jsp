...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">医务系统</td>
        <td align="right" valign="top" id="header-right">
        	<a href="LogoutServlet?action=logout" target="_parent" onFocus="this.blur()" class="admin-out">注销</a>
...
<SCRIPT type=text/javascript>showcal();</SCRIPT>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top" id="header-admin">医务系统后台管理</td>
